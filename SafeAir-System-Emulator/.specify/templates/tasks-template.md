...
- [ ] T004 Add constitution compliance checklist to project docs or PR template
...
- [ ] T005 Validate UML-to-code mapping for planned components
- [ ] T006 [P] Establish package structure and dependency boundaries
- [ ] T007 [P] Implement factories and block direct instantiation paths
- [ ] T008 Define domain validation utilities and error contracts
- [ ] T009 Configure test baseline (JUnit 5 + mocking/integration strategy)
- [ ] T010 Configure quality gates (coverage, static analysis, TODO/import/comment checks)
...
- [ ] T012 [P] [US1] Constitution conformance tests for UML/domain rules in tests/[path]
